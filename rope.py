...
from metapy.ts_utils.custom_layers import PositionalEncoding
from metapy.ae_utils import utils as utils_cae
from metapy.ae_utils.attn_models import COAE
...
class ROPE:
    ...
    def __init__(
        ...
        coae_config_yaml: str = "data/weights/finetuned_coae/config.yaml",
        coae_weights_pth: str = "data/weights/finetuned_coae/best_weights_1gpu.pth",

        lstm_dir: str = "data/Models/Storms/LSTM MODELS",
        gru_dir: str = "data/Models/Storms/GRU MODELS",
        transformer_dir: str = "data/Models/Storms/TRANSFORMER MODELS",
        meta_model_path: str = "data/Meta Models/MetaStormTunedBLa0.keras",
